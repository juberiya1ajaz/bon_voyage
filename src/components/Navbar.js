      ...
      <nav className="flex items-center py-2 flex-wrap px-4 text-fontColor tracking-wider">
              ...
              <div className="relative my-6 mx-auto w-screen">
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-secondary outline-none focus:outline-none">
                  ...
                  <div className="grid justify-center ">
                    <div className="inline-flex w-64 h-1  rounded-full"></div>
                  </div>

                  <div className="grid place-items-center text-xl py-2 gap-2 w-full mb-4">
                    <Link to="/">
                      <span className=" font-bold lg:inline-flex px-3 mx-3 py-2 rounded items-center justify-center dark:hover:bg-navHover hover:bg-secondary cursor-pointer text-black ">
                        Home
                      </span>
                    </Link>

                    <Link to="/chat">
                      <span className="lg:inline-flex px-3 mx-3 py-2 rounded items-center justify-center dark:hover:bg-navHover hover:bg-secondary cursor-pointer text-black font-bold">
                        Chatroom
                      </span>
                    </Link>
                    ...
                    <button
                      className="bg-red-400 hover:bg-red-500 border-black border-2 border-r-4 border-b-4 text-black py-2 px-8 rounded-md ml-2"
        ...
        <div className="hidden top-navbar w-full lg:inline-flex lg:flex-grow lg:w-auto">
          <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full text-xl lg:items-center items-start flex flex-col lg:h-auto space-x-2 mr-12">
            <Link to="/">
              <span className=" font-bold lg:inline-flex lg:w-auto w-full px-3 py-2 rounded items-center justify-center dark:hover:bg-navHover hover:bg-secondary cursor-pointer text-black">
                Home
              </span>
            </Link>

            <Link to="/chat">
              <span className="lg:inline-flex lg:w-auto w-full px-3 py-2 rounded items-center justify-center dark:hover:bg-navHover hover:bg-secondary cursor-pointer text-black font-bold">
                Chatroom
              </span>
            </Link>
            ...
            <button
              className="bg-red-400 hover:bg-red-500 border-black border-2 border-r-4 border-b-4 text-black py-2 px-8 rounded-md"
              onClick={() => auth.signOut()}
            >
              Logout
            </button>
